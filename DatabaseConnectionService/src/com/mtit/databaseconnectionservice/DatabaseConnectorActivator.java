	...
	public void start(BundleContext context) throws Exception {
		...
		try {
	      ...
	      //Establish the DB connection
	    	...
	    	// Register the DatabaseConnectionService
	        dbServiceRegistration  = context.registerService(DatabaseConnectionService.class.getName(), databaseConnectionService, null);
			
		}catch (ClassNotFoundException e) {
	        System.err.println("Error: MySQL JDBC driver class not found.");
	        e.printStackTrace(); // Print stack trace for debugging
	        throw new Exception("MySQL JDBC driver class not found.", e); // Re-throw the exception to signal bundle activation failure
	    } catch (SQLException e) {
	        System.err.println("Error: Failed to establish DB connection.");
	        e.printStackTrace(); // Print stack trace for debugging
	        throw new Exception("Failed to establish DB connection.", e); // Re-throw the exception to signal bundle activation failure
	    }
